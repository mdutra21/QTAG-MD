subroutine sobol_dataset(m, n, skip, output_filename)
...
!  integer ( kind = 4 ) skip
  ...
  character(len=255), intent(out) :: output_filename
!  call timestamp ( )

!  write ( *, '(a)' ) ' '
!  write ( *, '(a)' ) 'SOBOL_DATASET'
!  write ( *, '(a)' ) '  FORTRAN90 version.'
!  write ( *, '(a)' ) ' '
!  write ( *, '(a)' ) '  Generate a Sobol quasirandom dataset.'
!
...
!    write ( *, '(a)' ) &
!      '  Another is the least power of 2 greater than or equal to N.'

!    read ( *, *, iostat = ios ) skip

!  end if

!  write ( *, '(a,i6)' ) '  SKIP = ', skip
!
!  Generate the data.
!
  allocate ( r(1:m,1:n) )
...
!
  write ( output_filename, '(a,i2.2,a,i5.5,a)' ) 'sobol_', m, '_', n, '.txt'

  call r8mat_write ( output_filename, m, n, r )

!  write ( *, '(a)' ) ' '
!  write ( *, '(a)' ) '  The Sobol data was written to the file "' &
